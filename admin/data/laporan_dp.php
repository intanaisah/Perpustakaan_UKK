    ...
    <div class="container">
        <div class="row">
            <div class="col text-center mt-3">
                ...
                <h3>APLIKASI PERPUSTAKAAN DIGITAL DAERAH WULUHAN</h3>
        ...
        <div class="row">
            <div class="col">
                ...
                <p class="">Kepala Dinas Perpustakan Daerah Wuluhan</p>
                <p class="" style="margin-top: 4rem;"><b>Isnaini Dwi Susanti SH,MSi.</b></p>
            </div>
        </div>
        <div class="row">
